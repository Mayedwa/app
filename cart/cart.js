...
const products = [
    ...
    { name: "Converse Chuck Taylor", category: "men", price: 1600, img: "https://via.placeholder.com/300x200?text=Converse+Chuck+Taylor" },
    { name: "Nike ZoomX", category: "women", price: 2800, img: "https://via.placeholder.com/300x200?text=Nike+ZoomX" },
    { name: "Adidas NMD", category: "men", price: 2700, img: "https://via.placeholder.com/300x200?text=Adidas+NMD" },
    { name: "Fila Disruptor", category: "women", price: 1900, img: "https://via.placeholder.com/300x200?text=Fila+Disruptor" },
    { name: "Reebok Pump", category: "men", price: 3500, img: "https://via.placeholder.com/300x200?text=Reebok+Pump" },
    { name: "Adidas Yeezy", category: "men", price: 4500, img: "https://via.placeholder.com/300x200?text=Adidas+Yeezy" },
